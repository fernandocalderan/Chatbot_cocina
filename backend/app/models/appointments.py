...
class Appointment(Base):
    ...
    __table_args__ = (
        sa.Index("ix_appointments_tenant_slot", "tenant_id", "slot_start"),
    )
    ...
    external_event_id_google = sa.Column(sa.String(255), nullable=True)
    external_event_id_microsoft = sa.Column(sa.String(255), nullable=True)
